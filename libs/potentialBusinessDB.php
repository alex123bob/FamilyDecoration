<?php
	...
	function getTeleMarketingStaffList(){
		global $mysql;
		$sql = "select distinct telemarketingStaffName, telemarketingStaff from `potential_business` where telemarketingStaffName IS NOT NULL and telemarketingStaffName <> '' and isTransfered = 'false' and isDeleted = 'false' ";
