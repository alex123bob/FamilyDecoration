<?php
	...
	$TableMapping = array(
		...
		'project'=>array('projectId','projectName','captain','isFrozen'),
		...
		"account_log_monthly_check"=>array('id','accountId','scale','checkMonth','income','outcome','balance','checker','status'),
