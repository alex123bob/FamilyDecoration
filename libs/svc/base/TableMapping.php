<?php
	...
	$TableMapping = array(
		...
		"statement_bill"=>array('id','creator','billName','billValue','status','checker','billType','payee','payer','projectId','projectName','phoneNumber','totalFee','claimAmount','payedTimes','paidAmount','paidTime','projectProgress','professionType'),
