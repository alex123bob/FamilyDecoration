<?php
	...
	$TableMapping = array(
		...
		"statement_bill"=>array('id','creator','billName','billValue','status','checker','billType','payee','payer','projectId','projectName','phoneNumber','totalFee','claimAmount','payedTimes','projectProgress','professionType'),
		...
		"salary"=>array('user','basicSalary','positionSalary','meritSalary','socialTax','balance','paid','paidTime','payee','status'),
