<?php
	...
	$TableMapping = array(
		...
		"statement_bill"=>array('bidTime', 'accountName', 'bank', 'accountNumber', 'id','refId','businessId','staffSalaryId','deadline','creator','billName','billValue','status','checker','billType','payee','payer','projectId','projectName','phoneNumber','totalFee','claimAmount','payedTimes','paidAmount','paidTime','projectProgress','descpt','certs','reimbursementReason','professionType', 'supplierId'),
		...
		'project'=>array('salesmanName','salesman','designerName','designer','period','settled','projectId','projectName','captain','isFrozen','captainName','businessId'),
		'business'=>array('id','isTransfered'),
