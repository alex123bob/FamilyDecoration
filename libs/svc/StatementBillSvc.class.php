...
class StatementBillSvc extends BaseSvc
{
	...
	public static $BILLTYPE = array('bidbond'=> '投标保证金', 'pmbond'=> '履约保证金', 'bidbondBk'=> '投标保证金(退)', 'pmbondBk'=> '履约保证金(退)','ppd'=>'预付款','reg'=>'工人工资','stfs'=>'员工工资','dsdpst'=>'设计定金','qgd'=>'质量保证金','fdf'=>'财务费用(TODO)','pjtf'=>'工程款','mtf'=>'材料付款','rbm'=>'报销','wlf'=>'福利','tax'=>'公司税务','other'=>'其他');
