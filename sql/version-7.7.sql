...
CREATE TABLE `plan_making` (
  ...
  `c2` varchar(21) DEFAULT NULL ,
  `c3` varchar(21) DEFAULT NULL ,
  `c4` varchar(21) DEFAULT NULL ,
  `c5` varchar(21) DEFAULT NULL ,
  `c6` varchar(21) DEFAULT NULL ,
  `c7` varchar(21) DEFAULT NULL ,
  `c8` varchar(21) DEFAULT NULL ,
  `c9` varchar(21) DEFAULT NULL ,
  `c10` varchar(21) DEFAULT NULL ,
  `c11` varchar(21) DEFAULT NULL ,
  `c12` varchar(21) DEFAULT NULL ,
  `c13` varchar(21) DEFAULT NULL ,
  `c14` varchar(21) DEFAULT NULL ,
  `c15` varchar(21) DEFAULT NULL ,
  `c16` varchar(21) DEFAULT NULL ,
  `c17` varchar(21) DEFAULT NULL ,
  `c18` varchar(21) DEFAULT NULL ,
  `c19` varchar(21) DEFAULT NULL ,
  `c20` varchar(21) DEFAULT NULL ,
  `c21` varchar(21) DEFAULT NULL ,
  `c22` varchar(21) DEFAULT NULL ,
  `c23` varchar(21) DEFAULT NULL ,
  `c24` varchar(21) DEFAULT NULL ,
  `c25` varchar(21) DEFAULT NULL ,
  `c26` varchar(21) DEFAULT NULL ,
  `c27` varchar(21) DEFAULT NULL ,
  `c28` varchar(21) DEFAULT NULL ,
  `c29` varchar(21) DEFAULT NULL ,
  `c30` varchar(21) DEFAULT NULL ,
  `c31` varchar(21) DEFAULT NULL ,
  `c32` varchar(21) DEFAULT NULL ,
  `c33` varchar(21) DEFAULT NULL ,
  `c34` varchar(21) DEFAULT NULL ,
  `isDeleted` varchar(5) DEFAULT NULL,
  `createTime` datetime DEFAULT NULL,
  `updateTime` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
update `system` set `paramDesc`='', `isDeleted`='false', `id`='4', `updateTime`='0000-00-00 00:00:00', `paramName`='version', `createTime`='2015-04-11 13:51:14', `paramValue`='version-7.7' where `id`='4';
