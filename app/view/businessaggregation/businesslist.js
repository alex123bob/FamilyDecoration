Ext.define('FamilyDecoration.view.businessaggregation.BusinessList', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.businessaggregation-businesslist',
    requires: [
        'FamilyDecoration.store.Business'
    ],
    needFilter: true,
    itemDblClick: undefined,
        ...
        Ext.override(me, {
            ...
            listeners: {
                itemdblclick: function (view, rec, item, index, e, opts) {
                    if (me.itemDblClick) {
                        me.itemDblClick(view, rec, item, index, e, opts);
                    }
                    else {
                        window.busi = {
