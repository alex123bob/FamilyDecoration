Ext.define('FamilyDecoration.view.business.Index', {
	extend: 'Ext.container.Container',
	alias: 'widget.business-index',
	requires: ['FamilyDecoration.view.business.EditCommunity', 'FamilyDecoration.view.business.EditClient',
			   'FamilyDecoration.view.business.TransferToProject', 'FamilyDecoration.view.business.EditInfo',
			...
			items: [{
				...
				tbar: [{
					...
					handler: function (){
						...
						if (rec) {
							var win = Ext.create('FamilyDecoration.view.business.EditClient', {
								community: rec
							});
							win.show();
						}
			    ...
			    bbar: [{
					...
					handler: function (){
						var clientGrid = Ext.getCmp('gridpanel-clientInfo'),
							rec = clientGrid.getSelectionModel().getSelection()[0];
						if (rec) {
							var win = Ext.create('FamilyDecoration.view.business.EditInfo', {
					...
					handler: function (){
						var communityGrid = Ext.getCmp('gridpanel-community'),
							...
							community = communityGrid.getSelectionModel().getSelection()[0],
							client = clientGrid.getSelectionModel().getSelection()[0];
						var win = Ext.create('FamilyDecoration.view.business.TransferToProject', {
							community: community,
							client: client
						});
						win.show();
