Ext.define('FamilyDecoration.view.entrynexit.EntryNExitBoard', {
    ...
    initComponent: function () {
        ...
        me.columnMapping = {
                'workerSalary':           ['单号:1','姓名','联系方式:0.8','工程名称:1.5','款项名称','核算工资','申领工资','实付','余额','凭证','付款时间:1','付款人:0.8'],
                ...
                'qualityGuaranteeDeposit':['单号:1','工程名称:1','领款人','联系方式:0.8','应付金额','实付金额','付款日期:1','付款人','备注:1'],
                'designDeposit':          ['单号:1','工程名称:1','业务员','设计师','客户姓名','联系方式:0.8','收款额','收款人'],
                'projectFee':             ['单号:1','工程名称:1','项目经理','设计师','客户姓名','联系方式:0.8','应交款','已交款','款项','收款时间:1'],
                'loan':                   ['单号:1','项目名称:1','银行','交办人','联系方式:0.8','收款金额','收款人','收款时间:1','当前利率','期限','贷款时间:1'],
                'other':                  ['单号:1','项目名称:1','入账单位','交款人','联系方式:0.8','收款金额','收款人','收款时间:1','款项归属']
        }
