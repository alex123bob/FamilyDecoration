...
imagettftext($img, $labelFontSize, 0, 150, 170, $black, $font, "业务之星");
imagettftext($img, $labelFontSize, 0, 150, 220, $black, $font, "签单之星");
imagettftext($img, $labelFontSize, 0, 150, 270, $black, $font, "项目之星");
